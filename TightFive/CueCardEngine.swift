...
final class CueCardEngine: ObservableObject {
    ...
    private func processTranscript(_ transcript: String) {
        ...
        if exitResult.matches {
            ...
            print("✅ Exit phrase detected (confidence: \(String(format: "%.2f", exitResult.confidence)))")
        ...
        if anchorResult.matches {
            ...
            print("✅ Anchor phrase confirmed (confidence: \(String(format: "%.2f", anchorResult.confidence)))")
        }
    }
